/**
 * Autheur: Theo Bensaci | Date: 20:53 16.11.2025 | Description: Entity use to test network system
...
public class TestNetworkEntity extends CollisionBody
  ...
  public void draw(Graphics g) {
    ...
    BufferedImage face = new BufferedImage((int) (50), (int) (50), BufferedImage.TYPE_INT_ARGB);
    ...
    g.drawImage(
        SpriteRenderUtils.getSpriteFromSpriteSheet(_sprite, 32, 32, _testAnim.getValue()),
        (int) (p_position.x) - 25,
        (int) (p_position.y) - 25,
        null);
