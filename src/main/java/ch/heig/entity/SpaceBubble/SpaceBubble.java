/** Autheur: Theo Bensaci | Date: 18:06 12.11.2025 | Description: Bubble (check design) */
...
public class SpaceBubble extends CollisionBody
    implements IDrawable, IUpdatable, INetworkSenderEntity, INetworkReceiverEntity {
  public static final float PLAYER_COLLISION_MARGE = 5f;
  public static final float RADIUS_DECADE = 0.015f;
  public static final float RADIUS_REGENERATE = 0.05f;
  public static final float INACTIVE_RADIUS_REGENERATE = 0.015f;
  public static final float MIN_RADIUS = 10f;
  public static final float INACTIVE_TIME = 1000f;
  public static final float DAMAGE_VALUE = 10f;
  ...
  public void draw(Graphics g) {
    ...
    g.drawString(
        "R : " + collisionRadius,
        (int) (p_position.x - collisionRadius),
        (int) (p_position.y - collisionRadius) + 20);
    g.drawString(
        "draw layer : " + getLayer(),
        (int) (p_position.x - collisionRadius),
        (int) (p_position.y - collisionRadius) + 40);
  }
  ...
  public void update(float deltaTime) {
    ...
    if (!_hasPlayer) {
      float newRad =
          collisionRadius
              + (_isActive ? RADIUS_REGENERATE : INACTIVE_RADIUS_REGENERATE) * deltaTime;
