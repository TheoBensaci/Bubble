/** Autheur: Theo Bensaci | Date: 20:38 17.11.2025 | Description: Class use to manage animation */
...
public class Animation<E> {
  ...
  public float getTime() {
    return (float) (System.currentTimeMillis() - _startTime) / 1000f;
  }

  public float getMaxTime() {
    return _keyframes[_keyframes.length - 1].timeStamp;
  }
}
