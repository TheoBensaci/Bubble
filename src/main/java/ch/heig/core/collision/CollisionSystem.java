/** Autheur: Theo Bensaci | Date: 18:06 12.11.2025 | Description: Class use to manage collision */
...
public class CollisionSystem {
  ...
  private final ArrayList<CollisionBody> _bodys =
      new ArrayList<>(); // list of collision body managed
