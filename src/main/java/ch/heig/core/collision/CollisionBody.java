/**
 * Autheur: Theo Bensaci | Date: 18:06 12.11.2025 | Description: Entity implementing basic collision
 */
...
public class CollisionBody extends Entity {
  ...
  /**
   * Do the collision with a other collision body A collision is : Check distance -> collision
   * resolution
   *
