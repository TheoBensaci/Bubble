/**
 * Autheur: Theo Bensaci | Date: 18:06 12.11.2025 | Description: Use to manage ressource of the game
 * I want to make ressource load if you need it, for example, if you launche the game UI-less -> no
 * need to load sprite Also i want a system to handle miss loaded ressource, like a missing texture
 * for example
 */
...
public class RessourceManager {
  public final Map<String, BufferedImage> textures =
      new HashMap<>(); // list of texture loaded so far
  ...
  public static BufferedImage getTexture(String path) {
    ...
    return RessourceManager.getAsset(
        path,
        r.textures,
        data -> {
          if (data == null) {
