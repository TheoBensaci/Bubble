/** Autheur: Theo Bensaci | Date: 18:06 12.11.2025 | Description: Class use to manage input */
...
public class Input implements KeyListener, MouseListener {
  ...
  public boolean getNum6() {
    return _num_6;
  }

  public boolean getNum7() {
    return _num_7;
  }

  public boolean getNum8() {
    return _num_8;
  }

  public boolean getNum9() {
    return _num_9;
  }
  ...
  public Point getMousePos() {
    if (_game == null || _game.window == null) return new Point();
    GameRender r = _game.window.gameCanvas;
    PointerInfo pi = MouseInfo.getPointerInfo();
    if (pi == null || !_game.isRunning()) return new Point();
