 ...
 *   Date: 07:04 26.11.2025
 *   Description: packet use to manage client command on the server
 *   Command packet use to manage client command on the server
 *   When a command is accepted, the server send this packet with commandType = "log" and arg = result message
 *   If the command is not accepted, the server send this packet with commandType = "error" command with arg = Error message
 *   In any case, the packet will have the same id
 */
...
public class CommandPacket extends Packet{
    public static final String CommandOpHelp="game\n" +
