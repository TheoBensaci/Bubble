/** Autheur: Theo Bensaci | Date: 18:06 12.11.2025 | Description: client variant of the game */
...
public class ClientGame extends NetworkGame {
  ...
  public ClientGame(LoginPacket loginPacket, String title) {
    ...
    this.player =
        (ClientPlayer)
            createEntity(
                new ClientPlayer(loginPacket.playerColor, new Vector2f(0, 0), true, this.username),
                0,
                loginPacket.id);
  }
