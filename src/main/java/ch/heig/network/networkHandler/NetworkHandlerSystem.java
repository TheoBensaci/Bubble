/**
 * Autheur: Theo Bensaci | Date: 18:06 12.11.2025 | Description: class use to manage network in the
 * game
 */
...
public abstract class NetworkHandlerSystem {
  ...
  protected ArrayList<INetworkReceiverEntity> _recever =
      new ArrayList<>(); // list of entity receving data
  protected ArrayList<INetworkSenderEntity> _sender =
      new ArrayList<>(); // list of entity sending data
