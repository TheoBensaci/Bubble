/** Autheur: Theo Bensaci | Date: 14:48 01.12.2025 | Description: utils for the client cli */
package ch.heig.cli;
...
public class ClientCliUtils {
  ...
  public static void printColorSelectionMessage() {
    ...
    for (int i = 0; i < 7; i++) {
      str.append(getPlayerColorChatColor(i))
          .append(i)
          .append(" ■")
          .append(CliUtils.RESET)
          .append("| ");
    }
  ...
  public static void printClientStartMessage(String hostname, int hostPort, int listenport) {
    System.out.println(
        "Client start with port : "
            + listenport
            + "\nServer selected : "
            + hostname
            + ":"
