...
public class Arena {
    ...
    public static void drawBackground(Graphics g) {
        ...
        g.fillOval((int)(position.x- radiuse),(int)(position.y- radiuse),(int) radiuse *2,(int) radiuse *2);
    }
    ...
    public static void drawOutline(Graphics g) {
        ...
        g.drawOval((int)(position.x- radiuse- n),(int)(position.y- radiuse - n),(int) radiuse *2 + n*2,(int) radiuse *2 + n*2);
